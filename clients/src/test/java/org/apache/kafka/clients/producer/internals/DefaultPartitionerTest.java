...
public class DefaultPartitionerTest {
    ...
    public void testKeyPartitionIsStable() {
        ...
        int partition = partitioner.partition("test",  null, KEY_BYTES, null, null, cluster, 0);
        assertEquals(partition, partitioner.partition("test", null, KEY_BYTES, null, null, cluster, 0), "Same key should yield same partition");
    }
}
