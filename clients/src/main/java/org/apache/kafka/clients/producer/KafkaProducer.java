...
import org.apache.kafka.clients.producer.internals.FeedbackPartitioner;
...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(ProducerConfig config,
        ...
        try {
            ...
            System.out.printf("Using the %s.%n", partitioner.getClass().toString());
            System.out.printf("The allotment is %d.%n", config.getInt(ProducerConfig.FEEDBACK_QUEUE_ALLOTMENT));
            ...
            // Default 1M; heuristic 10M
            this.maxRequestSize = config.getInt(ProducerConfig.MAX_REQUEST_SIZE_CONFIG);
            // Default 32M
            this.totalMemorySize = config.getLong(ProducerConfig.BUFFER_MEMORY_CONFIG);
            // set compression type for higher throughput
            ...
            // set up record accumulator that batches records before sending
            ...
            // collect information of the cluster for data transmission
            if (metadata != null) {
            ...
            // encapsulate business code into thread code
    ...
    Sender newSender(LogContext logContext, KafkaClient kafkaClient, ProducerMetadata metadata) {
        ...
        KafkaClient client = kafkaClient != null ? kafkaClient : new NetworkClient(
                ...
                logContext);
        /**
         *  0- no ack at all; 1- only leader ack; -1- all ack
         * */
    ...
    private Future<RecordMetadata> doSend(ProducerRecord<K, V> record, Callback callback) {
        ...
        try {
            ...
            // verify that the size of the request is less than the max request size and max memory size
            ...
            if (result.batchIsFull || result.newBatchCreated) {
                ...
                // where the real sending job is done
                this.sender.wakeup();
            }
